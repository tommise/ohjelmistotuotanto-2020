...
public class Stepdefs {
    ...
    public void invalidUsernameAndValidPasswordAndMatchingPasswordConfirmationAreEntered(String username, String password) {
        registerWith(username, password, password);
    }
    ...
    @When("a valid username {string} and password {string} and invalid password confirmation {string} are entered")
    public void aValidUsernameAndPasswordAndInvalidPasswordConfirmationAreEntered(String username, String password, String confirmation) {
